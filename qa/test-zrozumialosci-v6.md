...
- klucz oczekiwanych przedmiotów i czynności: pola `finalny_kadr` oraz `czynność` w `copydeck_droga_do_miliona_dla_marketingu_v2.csv` — prowadzący nie pokazuje ich testerowi.

## Procedura

1. Zbierz co najmniej pięć osób spoza zespołu implementacyjnego.
2. Dla każdej osoby pokaż każdy kadr przez dokładnie pięć sekund, najpierw desktop, potem 390 px. Ukryj kartę copy; pozostaw wyłącznie ilustrację.
...
5. Oznacz trafienie osobno dla przedmiotu i czynności, porównując dopiero po odpowiedzi z ukrytym kluczem w copydecku.
